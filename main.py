...
if __name__ == "__main__":
    ...
    # [?]1902-27301[?]: 6610/6654 -> 250
    # test = "D:/Data/Beton/Real/HPC1-crop-around-crack.tif"
    # test = "D:/Data/Beton/Real/NC2-crop-around-crack.tif"

    # Net works best on data in [0 255]
    tgt_max_val = 255
    scale_from_tgt = 1
    data = BetonImg(test, load="results/best/pred_real2.npy", max_val=tgt_max_val * scale_from_tgt,
    ...
    # data.plot_layer(1100, mode="cmap")
